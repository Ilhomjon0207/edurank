...
export class SkillController {
  ...
  addUserSkill(
    ...
    return this.skillService.addUserSkill(userId, dto);
  }

  @Get('users/:userId')
  getUserSkills(@Param('userId', ParseIntPipe) userId: string) {
  ...
  updateUserSkill(
    ...
    return this.skillService.update(userId, skillId, level);
  }
  ...
  removeUserSkill(
    ...
    return this.skillService.removeUserSkill(userId, skillId);
  }
}
